...
def my_horizon_scene_class_network(
    ...
    conv_7 = Convolution2D(filters_num, (kernel, kernel), padding="same", data_format=data_format,  trainable=train_backbone)(conv_5)
    ...
    conv_10 = Convolution2D(filters_num, (kernel, kernel), padding="same", data_format=data_format,  trainable=train_backbone)(conv_8)
    ...
    conv_16 = Convolution2D(filters_num, (kernel, kernel), padding="same", data_format=data_format, trainable=train_backbone)(conv_14)
    conv_16 = BatchNormalization(trainable=train_backbone)(conv_16)
    conv_16 = Activation("relu")(conv_16)
    gap = GlobalAveragePooling2D()(conv_16)
    # # Classification
    fc0 = Dense(273, activation='relu')(gap)
